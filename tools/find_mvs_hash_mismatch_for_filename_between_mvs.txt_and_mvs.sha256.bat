...
set "app.name=find_mvs_hash_mismatch_for_filename_between_mvs.txt_and_mvs.sha256"
set "app.rc=0"
set "app.self=%~f0"
set "mvsx_mode=human"
set "mvsx_operation=hash_diagnostic"
set "mvsx_fields="
set "mvsx_search_source="
set "mvsx_algorithm_filter=SHA256"
set "mvsx_source_file=mvs.txt|mvs.sha256"
set "mvsx_diagnostic_kind=hash_mismatch"
set "mvsx_dump=%~1"
set "mvsx_search=%~2"
set "mvsx_caller=%~nx0"
