...
set "app.name=find_mvs_orphan_filenames_from_mvs.txt_in_mvs_names.txt"
set "app.rc=0"
set "app.self=%~f0"
set "mvsd_operation=orphan"
set "mvsd_property=filename"
set "mvsd_source=mvs.txt"
set "mvsd_target=mvs_names.txt"
set "mvsd_dump=%~1"
set "mvsd_caller=%~nx0"
