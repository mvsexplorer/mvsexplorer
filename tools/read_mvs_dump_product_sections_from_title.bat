...
set "app.name=read_mvs_dump_product_sections_from_title"
set "app.rc=0"
set "app.self=%~f0"
set "mvsx_mode=machine"
set "mvsx_operation=product_section_query"
set "mvsx_fields=section_occurrence,id,title,line_offset,line,raw"
set "mvsx_search_source=title"
