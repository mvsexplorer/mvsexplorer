...
set "app.name=read_mvs_dump_id_title_date_note_filenames_hashes_from_filename"
set "app.rc=0"
set "app.self=%~f0"
set "mvsx_mode=machine"
set "mvsx_operation=detail_query"
set "mvsx_fields=id,title,date,note,filename,hash"
