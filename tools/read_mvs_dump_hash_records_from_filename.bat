...
set "app.name=read_mvs_dump_hash_records_from_filename"
set "app.rc=0"
set "app.self=%~f0"
set "mvsx_mode=machine"
set "mvsx_operation=hash_query"
set "mvsx_fields=source,line,id,title,variant_title,filename,hash,algorithm"
set "mvsx_search_source=filename"
