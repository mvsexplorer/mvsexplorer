...
set "app.name=find_mvs_filename_with_multiple_hashes_in_mvs_names.txt"
set "app.rc=0"
set "app.self=%~f0"
set "mvsx_mode=human"
...
set "mvsx_source_file=mvs_names.txt"
set "mvsx_diagnostic_kind=filename_multiple_hashes"
set "mvsx_dump=%~1"
set "mvsx_search=%~2"
set "mvsx_caller=%~nx0"
